...
import { BRANCH_STATS, MONTHLY_STATS, MOCK_CLIENTS, MOCK_COUNSELORS } from '@/lib/mockData';
import {
...
export default function AdminDashboard() {
  ...
  const totalCounselors = MOCK_COUNSELORS.length;
  const totalCompleted = MOCK_CLIENTS.filter(c => c.employmentStatus === '취업완료').length;
  const avgRate = Math.round(totalCompleted / totalClients * 100);
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div className="bg-card rounded-md p-5 shadow-sm border border-border">
              ...
              <ResponsiveContainer width="100%" height={220}>
                <BarChart data={BRANCH_STATS} layout="vertical" barSize={14}>
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              { label: '진행 중', value: MOCK_CLIENTS.filter(c => c.employmentStatus === '미취업').length, unit: '명', color: '#4299E1' },
